...
.climate-card-section:first-child { padding-left: 0; }
.climate-card-section:last-child { padding-right: 0; }
...
Object.assign(climatePanel.style, {
  ...
  left: '50%',
  bottom: '28px',
  transform: 'translate(-50%, 140%)', // 初始藏在畫面下方外面
  zIndex: '250',
  pointerEvents: 'none',
  opacity: '0',
  transition: 'transform 0.6s ease, opacity 0.6s ease',
...
function showClimateHintBoxes() {
  ...
  climatePanel.style.transform = 'translate(-50%, 0)';

  clearTimeout(climateHideTimer);
  climateHideTimer = setTimeout(() => {
    climatePanel.style.opacity = '0';
    climatePanel.style.transform = 'translate(-50%, 140%)';
  }, 3000); // 維持3秒後自動收回
}
